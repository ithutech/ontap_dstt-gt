...
var script_url = "https://script.google.com/macros/s/AKfycbzGcS4gOcAyqd6YFyEczT5UoIFhbQmhsOxUzpKlvjuoshLnWW4/exec"
...
$("#submitIOT").click(function(event) {
	...
	var sdt = $("#sdt").val();
    var url = script_url + "?callback=result&masv=" + masv + "&lop=" + lop + "&email=" + email +  "&hovaten=" + hovaten  +"&sdt="+sdt+ "&action=register";
	console.log(url);
